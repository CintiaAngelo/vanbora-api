...
/**
 * Configuração do WebSocket/STOMP para o chat em tempo real.
 * Endpoint {@code /ws} (WebSocket nativo, sem SockJS — o app React Native usa o
 * WebSocket global). Broker simples publicando em {@code /topic}.
 */
@Configuration
